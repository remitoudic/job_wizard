...
class Application(SQLModel, table=True):
    ...
    generated_letter_id: Optional[int] = Field(
        default=None,
        foreign_key="generated_letters.id",
        index=True,
        description="Reference to generated letters",
    )
    ...
    notes: Optional[str] = Field(
        ...
        description="User notes for this application",
    )
