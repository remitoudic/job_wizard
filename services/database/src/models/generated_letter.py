...
class GeneratedLetter(SQLModel, table=True):
    ...
    application_id: Optional[int] = Field(default=None, foreign_key="applications.id", index=True, description="Reference to the application")
    user_id: int = Field(foreign_key="user.id", index=True, description="User who generated the letters")
