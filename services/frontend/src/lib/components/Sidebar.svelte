...
>
	...
	<nav class="flex flex-col gap-4 flex-1">
		...
		>
			...
			<span
				class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
				>{$_('nav.applications', { default: 'Applications' })}</span
			>
		</a>
		<a
			href="/cv-refresh"
		...
		>
			...
			<span
				class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
				>{$_('nav.cv_refresh', { default: 'CV Refresh' })}</span
			>
		</a>
		<a
			href="/profile"
		...
		>
			...
			{#if $auth.user?.profile_picture_url}
				<img
					...
					alt="Profile"
					class="h-6 w-6 rounded-full object-cover border border-[#334155]"
				/>
			{:else}
				<svg
					xmlns="http://www.w3.org/2000/svg"
			...
			<span
				class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
				>{$_('nav.profile', { default: 'Profile' })}</span
			>
		</a>
		<a
			href="/why"
		...
		>
			...
			<span
				class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
				>{$_('nav.why', { default: 'Why use this?' })}</span
			>
		</a>
		{#if $auth.user?.is_superuser}
			...
			>
				...
				<span
					class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
					>{$_('nav.admin', { default: 'Admin' })}</span
				>
			</a>
		{/if}
	</nav>
	...
	>
		...
		<span
			class="absolute left-full ml-4 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
			>{$_('nav.logout', { default: 'Logout' })}</span
		>
	</button>
</aside>
<nav
