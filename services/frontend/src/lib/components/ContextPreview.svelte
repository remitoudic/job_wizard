...
<div class="space-y-3">
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            {#if activeCVName}
                <div class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-50 border border-emerald-100 text-[10px] font-bold text-emerald-600 uppercase tracking-tight antialiased">
    ...
    {#if activeCVName}
        <div class="p-3 rounded-lg border border-[#E2E8F0] bg-white flex items-center justify-between group hover:border-[#0369A1]/30 transition-all">
            <div class="flex items-center gap-3 overflow-hidden">
                <div class="p-2 rounded-md bg-[#F8FAFC] text-[#64748B] group-hover:bg-[#F0F9FF] group-hover:text-[#0369A1] transition-colors">
                ...
                <div class="overflow-hidden">
                    ...
                    <div class="text-[10px] text-[#64748B]">
                        Active User CV • Linked to Profile
                    </div>
                </div>
            </div>
    ...
    {:else if !isAuthenticated}
        <div class="p-3 rounded-lg border border-dashed border-[#E2E8F0] bg-[#F8FAFC] text-center">
            <p class="text-[10px] text-[#64748B]">
                Log in to automatically use your stored CV data.
            </p>
        </div>
    {/if}
        ...
        <div class="animate-in fade-in slide-in-from-top-2">
            <div class="p-4 rounded-lg bg-[#0F172A] border border-slate-800 shadow-inner overflow-hidden">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-[9px] font-mono uppercase tracking-widest text-slate-500">LLM Data Stream (Preview)</span>
                </div>
                <div class="max-h-[120px] overflow-y-auto pr-2 custom-scrollbar">
                    <p class="text-[11px] font-mono text-slate-300 leading-relaxed break-words whitespace-pre-wrap selection:bg-sky-500/30">
                        {contextSnippet}
                    </p>
                </div>
            </div>
