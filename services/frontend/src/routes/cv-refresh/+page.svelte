                ...
                <div class="flex flex-col lg:flex-row gap-6 items-start">
                    ...
                    <div class="w-full lg:w-[38%] flex-shrink-0">
                        <div class="bg-white rounded-xl border border-[#E2E8F0] shadow-sm p-6">
                            <h2 class="text-xl font-bold text-[#0F172A] mb-5">
                                Choose a Template
                            </h2>
                                    ...
                                    >
                                        <div class="flex items-center gap-3">
                                            ...
                                            {#if selectedTemplate.startsWith(t.name)}
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#0369A1] flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        >
                                            <div class="flex flex-col items-center gap-1.5">
                                                <div class="w-8 h-10 border border-slate-300 rounded flex flex-col gap-0.5 p-1">
                    ...
                    >
                        ...
                        <!-- Preview frame -->
                        <div class="relative bg-white rounded-xl border border-[#E2E8F0] shadow-lg overflow-hidden" style="height: 680px;">
                            ...
                            {:else}
                                ...
                                <div class="absolute inset-0 flex flex-col items-center justify-center gap-3 text-slate-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
