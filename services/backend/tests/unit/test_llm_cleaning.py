...
This module contains unit tests for the regex-based cleaning and sanitization
logic applied to raw LLM responses. It verifies that markdown tags, internal
AI thinking, and other non-content artifacts are correctly stripped before
the final text is delivered to the user.
"""
