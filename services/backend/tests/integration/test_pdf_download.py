...
def test_pdf_generation_and_download_flow():
    ...
    assert response_static.status_code == 200, "Failed to access file via static /uploads mount"
    ...
    assert response_api.status_code == 200, "Failed to access file via /api/download endpoint"
